    ...
    <div className="bg-gray-900 text-gray-200">
      ...
      <header className="fixed w-full bg-gray-900/95 backdrop-blur-sm py-4 z-50 transition-all duration-300">
        <div className="container mx-auto px-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-yellow-200 hover:text-yellow-300 transition-colors duration-300">DoodleDuck</h1>
        ...
        <div className="relative container mx-auto px-4 py-32">
          <div className="max-w-3xl transform transition-all duration-700 hover:translate-x-2">
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-200">
              Interactive learning platform with AI-powered guidance, real-time coding environments,
              and a supportive community to help you achieve your coding goals.
            </p>
            ...
            {[
              {
                ...
                description: "Join our growing community of dedicated programmers"
              },
              {
                number: "200+",
                label: "Video Tutorials",
                description: "High-quality, curated content for effective learning"
              },
              {
                number: "15+",
      ...
      <div className="py-20 bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: <Terminal className="w-12 h-12 text-yellow-200 group-hover:text-yellow-300 transition-colors duration-300" />,
                title: "Interactive Code Editor",
                description: "Write, compile, and test code directly in your browser with our powerful editor."
              },
              {
                icon: <Brain className="w-12 h-12 text-yellow-200 group-hover:text-yellow-300 transition-colors duration-300" />,
                title: "AI-Powered Learning",
                description: "Get personalized suggestions and help from our AI assistant as you code."
              },
              {
                icon: <Book className="w-12 h-12 text-yellow-200 group-hover:text-yellow-300 transition-colors duration-300" />,
                title: "Comprehensive Curriculum",
                description: "Structured learning paths for multiple programming languages and skill levels."
              },
              {
                icon: <Timer className="w-12 h-12 text-yellow-200 group-hover:text-yellow-300 transition-colors duration-300" />,
                title: "Progress Tracking",
                description: "Monitor your learning journey with detailed progress analytics."
              },
              {
                icon: <Users className="w-12 h-12 text-yellow-200 group-hover:text-yellow-300 transition-colors duration-300" />,
                title: "Community Support",
                description: "Connect with fellow learners and mentors in our active community."
              },
              {
                icon: <Award className="w-12 h-12 text-yellow-200 group-hover:text-yellow-300 transition-colors duration-300" />,
                title: "Certification",
                description: "Earn certificates upon completing courses and projects."
              }
            ].map((feature, index) => (
              <div 
                key={index} 
              ...
              >
                <div className="mb-6 transform transition-all duration-300 group-hover:scale-110">{feature.icon}</div>
            ...
            {[
              {
                ...
                quote: "DoodleDuck helped me transition from a beginner to a confident developer. The AI suggestions are incredibly helpful!"
              },
              {
                name: "Michael Chen",
                role: "Computer Science Student",
                image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
                quote: "The interactive coding environment and community support made learning programming enjoyable and effective."
              },
              {
                name: "Emily Rodriguez",
                role: "Web Developer",
                image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
                quote: "The structured curriculum and progress tracking helped me stay motivated throughout my learning journey."
              }
            ...
            {[
              {
                ...
                answer: "We offer courses in Python, JavaScript, Java, C++, C#, and many more. Our curriculum is constantly expanding to include new languages and technologies."
              },
              {
                question: "Is DoodleDuck suitable for complete beginners?",
                answer: "Absolutely! Our platform is designed to accommodate learners of all levels, from complete beginners to advanced developers."
              },
              {
                question: "How does the AI-powered learning assistance work?",
                answer: "Our AI system analyzes your code in real-time, providing personalized suggestions, identifying potential errors, and offering optimization tips."
              },
              {
                question: "Can I access the platform on mobile devices?",
                answer: "Yes, DoodleDuck is fully responsive and can be accessed on any device with a web browser."
              }
            ].map((faq, index) => (
              <div 
                key={index} 
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="transform transition-all duration-300 hover:translate-x-2">
              <h3 className="text-xl font-bold text-yellow-200 mb-4">DoodleDuck</h3>
              <p className="text-gray-400">Empowering developers through interactive learning and AI-powered guidance.</p>
            </div>
            {[
              {
                title: "Quick Links",
              ...
              },
              {
                title: "Connect",
                links: [
                  { name: "GitHub", path: "https://github.com/N4M154/Design_Project-I-SWE-4506" },
                  { name: "Twitter", path: "#" },
                  { name: "LinkedIn", path: "#" },
                  { name: "Discord", path: "#" }
                ]
              ...
              <div key={index} className="transform transition-all duration-300 hover:translate-x-2">
                <h4 className="font-semibold text-yellow-200 mb-4">{section.title}</h4>
