...
//             role: "system",
//             content:
//               "You are a programming expert. Analyze the provided code for its space and time complexity. Suggest any potential improvements for performance optimization in a clear and concise way.",
//           },
//           {
//             role: "user",
...
//       // Combine execution output with Groq's analysis
//       setOutput(
//         `Execution Output:\n${executionOutput}\n\nGroq Analysis:\n${aiAnalysis}`
//       );
//     } catch (error) {
//       setOutput("Error: Failed to execute or analyze code. Please try again.");
//       console.error(error);
//     } finally {
//       setLoading(false);
//     }
...
//             {/* Input/Output/Analysis Section - Fixed 40% height */}
//             <div
//               className={`h-[40%] ${
//                 theme === "vs-dark"
//                   ? "bg-[#2D2D2D] border-[#404040]"
...
//                 {/* Output Panel */}
//                 <div
//                   className={`${inputNeeded ? "w-1/3" : "w-1/2"} p-4 border-r ${
...
//                 {/* Analysis Panel */}
//                 <div className={`${inputNeeded ? "w-1/3" : "w-1/2"} p-4`}>
//                   <div className="flex justify-between items-center mb-2">
//                     <h2
//                       className={`font-medium ${
//                         theme === "vs-dark" ? "text-white" : "text-gray-800"
