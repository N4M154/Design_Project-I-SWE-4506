...
export default function CMemoryManagement() {
  ...
  // Define the learning content for the "Memory Management" lesson
  const learningContent = {
    "memory-management": {
      title: "C Language Memory Management",
      intro:
        "Memory management in C refers to how memory is allocated and deallocated during program execution. This lesson will cover different types of memory allocation and memory management techniques.",
      sections: [
        {
          title: "What is Memory Management?",
          content: `Memory management in C involves allocating and freeing memory for variables, functions, and data structures during program execution.

Memory management can be broadly divided into:
• Static Memory Allocation
• Dynamic Memory Allocation`,
        },
        {
          title: "Static Memory Allocation",
          content: `Static memory allocation refers to memory that is allocated at compile time and cannot be changed during runtime. The memory is allocated in the data segment and remains fixed.
...
• Local variables declared in a function`,
        },
        {
          ...
          content: `Dynamic memory allocation is done during runtime, allowing flexible memory allocation as required by the program.

Common functions for dynamic memory allocation in C:
• malloc()
• calloc()
• realloc()
• free()`,
        },
        {
          ...
          content: `Memory leaks occur when dynamically allocated memory is not freed properly, causing a waste of memory. Best practices include:
• Always free dynamically allocated memory.
• Use tools like Valgrind to detect memory leaks.
• Keep track of allocated memory to avoid unnecessary allocations.`,
        },
      ],
      practice: [
        "Use malloc() to dynamically allocate memory for an integer array.",
        "Use free() to deallocate the memory after usage.",
        "Use calloc() to allocate memory for multiple elements initialized to zero.",
        "Use realloc() to resize an allocated memory block.",
      ],
    },
  };
  ...
  useEffect(() => {
    setRelatedVideos([
      ...
      {
        id: "2",
        title: "Memory Allocation Techniques in C Programming",
        thumbnail:
    ...
    setRelatedArticles([
      {
        id: "1",
        title: "A Deep Dive into Memory Management in C",
      ...
      {
        id: "2",
        title: "Memory Allocation and Deallocation in C",
