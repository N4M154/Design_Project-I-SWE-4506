...
//       <div className="max-w-lg mx-auto bg-gradient-to-r from-slate-700 via-slate-800 to-slate-900 mb-2 p-5 rounded-lg shadow-lg">
...
export default function Profile() {
  ...
  return (
    <div className="bg-slate-800 min-h-screen flex flex-col items-center">
      ...
      <div className="flex flex-row space-x-6 w-full max-w-6xl p-5">
        {/* Profile Section */}
