...
import { CheckCircle, Clock, Code2, Copy, Download, Play, RefreshCw, Trash2, XCircle } from 'lucide-react';
import React, { useEffect, useState } from 'react';
import SideButtons from "../components/SideButtons";
      ...
      >
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 mb-8 shadow-sm">
            <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-white">Your Statistics</h2>
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600">{stats.solved}</div>
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600">{stats.attempted}</div>
                <div className="text-gray-600 dark:text-gray-300">Problems Attempted</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-600">{stats.totalSubmissions}</div>
                <div className="text-gray-600 dark:text-gray-300">Total Submissions</div>
              </div>
            </div>
          </div>
                ...
                {output && (
                  <div className="p-4 border-t dark:border-gray-700">
                    <div className="flex justify-between items-center mb-2">
                      <h3 className="font-medium text-gray-800 dark:text-white">Output</h3>
                      <button
                        onClick={() => setOutput('')}
