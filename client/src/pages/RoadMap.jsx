...
//   const [generatedRoadmap, setGeneratedRoadmap] = useState(null); // New state for roadmap
...
//       setGeneratedRoadmap(response.data.roadmap.generatedRoadmap); // Store generated roadmap
//       setSuccessMessage("Your learning roadmap has been successfully created!"); // Display success message
//     } catch (error) {
...
//                     <option value="projects">Build personal projects</option>
//                     <option value="exams">
...
//                   <label className="block">
//                     <span className="text-gray-700">Please specify:</span>
//                     <input
//                       type="text"
...
//                         value={option.value}
//                         checked={
//                           formData.preferences.learningStyle === option.value
//                         }
//                         onChange={(e) =>
//                           setFormData({
//                             ...formData,
...
//               <div className="space-y-4">
//                 <fieldset className="space-y-2">
//                   <legend className="text-gray-700">Select Languages:</legend>
...
//                                 },
//                               ]
//                             : formData.languages.filter((l) => l.name !== lang);
...
const RoadmapForm = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-b from-[#FFFDF7] to-[#FFF9E6]">
      ...
      >
        {/* Hero Section
        <div className="bg-gradient-to-r from-[#FFF9E6] to-[#FFFDF7] border-b border-amber-100 py-16 px-6 mb-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-6">
              <Target className="w-16 h-16 text-amber-700 mx-auto animate-pulse" />
            </div>
            <h1 className="text-5xl font-bold text-amber-900 mb-6">
              Chart Your Path to Programming Success
            </h1>
            <p className="text-xl text-amber-800 max-w-2xl mx-auto leading-relaxed">
              Every great developer started with a plan. Let's create yours together. 
              Answer a few questions, and we'll craft a personalized roadmap that aligns 
              with your goals, schedule, and learning style.
            </p>
            <div className="mt-8 flex justify-center gap-4">
              <div className="px-6 py-3 bg-amber-50 rounded-lg border border-amber-200">
                <h3 className="font-semibold text-amber-800">Personalized Path</h3>
                <p className="text-amber-700 text-sm">Tailored to your goals</p>
              </div>
              <div className="px-6 py-3 bg-amber-50 rounded-lg border border-amber-200">
                <h3 className="font-semibold text-amber-800">Step-by-Step</h3>
                <p className="text-amber-700 text-sm">Clear learning milestones</p>
              </div>
              <div className="px-6 py-3 bg-amber-50 rounded-lg border border-amber-200">
                <h3 className="font-semibold text-amber-800">Expert Guidance</h3>
                <p className="text-amber-700 text-sm">Industry-aligned content</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto flex items-center gap-8">
            <div className="flex-1">
              ...
              <p className="text-amber-800 leading-relaxed">
                Tell us about your goals and preferences, and we'll create your personalized learning roadmap.
              </p>
            </div>
                ...
                {step === 1 && (
                  <div className="space-y-6 transition-all duration-300">
                    <div className="text-center mb-6">
                      ...
                      <h2 className="text-3xl font-bold text-amber-900">Your Learning Goals</h2>
                      <p className="text-amber-700 mt-2">Let's start by understanding what you want to achieve</p>
                    </div>
                    <div className="space-y-4">
                      <label className="block">
                        ...
                        >
                          ...
                          <option value="job">Land a job in tech</option>
                          <option value="projects">Build personal projects</option>
                          <option value="exams">Prepare for college/coding exams</option>
                          <option value="basics">Learn coding basics</option>
                          <option value="other">Other</option>
                        </select>
                      </label>
                      ...
                      {formData.goals.primaryGoal === "other" ? (
                        <label className="block">
                          <span className="text-amber-800">Please specify:</span>
                          <input
                            type="text"
                            value={formData.goals.specificArea}
                            onChange={(e) =>
                        ...
                        <label className="block">
                          <span className="text-amber-800">Specific Area of Interest:</span>
                          <input
                            type="text"
                            value={formData.goals.specificArea}
                            onChange={(e) =>
