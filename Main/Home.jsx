...
import { BookOpen, Brain, Code2, Cpu, PenTool, Terminal, Timer, Trophy } from "lucide-react";
...
export default function Home() {
  ...
  const features = [
    { icon: Terminal, title: "Code Editor", description: "Write and test code in browser" },
    { icon: Brain, title: "AI Assistant", description: "Get personalized help" },
              ...
              {stats.map((stat, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="text-base text-gray-700 font-medium">{stat.label}</h3>
                  </div>
                );
              })}
            </div>
